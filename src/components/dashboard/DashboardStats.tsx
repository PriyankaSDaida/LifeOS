    ...
    return (
        <div className="grid gap-6 md:grid-cols-3">
            <Link href="/calendar" className="block h-full">
                <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-sky-500 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900/50">
            ...
            <Link href="/finance" className="block h-full">
                <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-emerald-500 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900/50">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Link href="/journal" className="block h-full">
                <Card className="h-full hover:shadow-lg transition-all duration-300 border-l-4 border-l-purple-500 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900/50">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
